...
copyright = 'The {{ cookiecutter.project_name }} authors'
author = 'The {{ cookiecutter.project_name }} authors'
...
latex_documents = [
    (master_doc, '{{cookiecutter.project_slug}}.tex', 'Trio Documentation',
     author, 'manual'),
]
